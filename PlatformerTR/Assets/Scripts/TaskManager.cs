...
namespace Tools
{
    public static class TaskManager
    {
        ...
        public static async UniTask WaitUntilDelay(float seconds, CancellationToken ctn)
        {
            await UniTask.Delay((int)(seconds * 1000), ignoreTimeScale: false, cancellationToken: ctn);
        }
